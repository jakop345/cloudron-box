...
DirIndex.prototype.update = function (callback) {
...
DirIndex.prototype.add = function (file) {
};

DirIndex.prototype.update = function (file) {
};

DirIndex.prototype.remove = function (file) {
};
