...
function initializeExpressSync() {
    ...
    router.get ('/api/v1/settings/appstore',           settingsScope, routes.user.requireAdmin, routes.settings.getAppstore);
    router.post('/api/v1/settings/appstore',           settingsScope, routes.user.requireAdmin, routes.settings.setAppstore);
